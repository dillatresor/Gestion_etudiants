...
{
    $MllePersonnel=$_GET['MllePersonnel'];
    $value=$persManager->get($MllePersonnel);
}
...
<body>
    ...
    <div class="mt-3 pull-right d-flex">  
        ...
        <div class="bienvenu">MODIFIER UN AGENT</div>
      <div class="global-content">
        ...
        ?>
            ...
            <form class=" form p-4 d-flex flex-column w-100" action="edit.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" class="champ" name="MllePersonnel" value="<?= $value->MllePersonnel?>">
                ...
                <label for="">Nom</label>      
                <input type="text" class="champ" name="NomPersonnel" value="<?= $value->NomPersonnel?>">
                <label for="">Prénom</label>   
                <input type="text" class="champ" name="PrenomPersonnel" value="<?= $value->PrenomPersonnel?>">
                <label for="">Emploie</label>   
                <input type="text" class="champ" name="Emploie" value="<?= $value->Emploie?>"> 
                <label for="">Catégorie</label>   
                <input type="text" class="champ" name="Categorie" value="<?= $value->Categorie?>">       
