...
<body>
    ...
    <div class="mt-3 pull-right d-flex">  
        ...
        <div class="bienvenu">INSERTION D'UN CONTRIBUABLE</div>
      <div class="global-content">
        ...
        ?>
            ...
            <form class=" form p-4 d-flex flex-column w-100" action="new.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text" class="champ" name="numIfu" required>
                <label for="">Nom contribuable</label>  
                <input type="text" class="champ" name="NomEntreprise" required>
                <label for="">Direction</label>      
                <input type="text" class="champ" name="DirectionE" required>
                <label for="">Regime Fiscal</label>   
                <input type="text" class="champ" name="RegimeFiscal" required>      
