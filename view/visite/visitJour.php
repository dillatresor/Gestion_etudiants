...
<body>
  ...
  <div class="container" id="container">
    ...
    <div class="bienvenu">LISTE DES VISITES DU JOUR</div>
    <div class="global-content">
      ...
      <div class="cache">
        <div class="c-table">
          <!-- <button type="button" class="btn btn-info m-3"> <a class="text-light" href="#"> Visite du jour </a> </button> -->
          <button type="button" class="btn btn-info m-3"> <a class="text-light" href="visitCours.php"> Visite en cours </a> </button>
