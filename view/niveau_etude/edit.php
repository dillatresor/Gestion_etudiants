...
$bd= bd();
$nivCont=new niveau_etudeControleur($bd);

if(isset($_POST['id_niveau']) and $_POST['valeur'])
{
    $nivCont =new niveau_etudeControleur($bd);
    $niv=new niveau_etude($_POST);
    $nivCont->edit($niv);
...
<body>
    ...
    <div class="mt-3 pull-right d-flex">  
        ...
        <div class="bienvenu">MODIFICATION D'UN NIVEAU_ETUDE</div>
      <div class="global-content">
        ...
        ?>
            ...
            <form class=" form p-4 d-flex flex-column w-100" action="edit.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" class="champ" name="valeur" value="<?= $value->valeur?>">      
